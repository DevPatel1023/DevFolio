...
const Section = () => {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section
        id="about"
        className="py-20 md:py-32 scroll-mt-16 bg-gray-900/50 backdrop-blur-sm"
      >
        <div className="container grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="space-y-6 ">
            <Badge
              text="About Me"
              className="px-3 py-1 text-sm bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 text-cyan-300"
            />
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                experience building cutting-edge web applications. I specialize
                in React, Next.js, Node.js, and modern web technologies.
              </p>
              <p>
                My journey began at 19 when I built my first website. Since
                then, I've collaborated with startups and established companies
                to create intuitive, performant digital experiences that drive
                results.
              </p>
              <p>
